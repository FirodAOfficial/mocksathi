  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        // rendering the result in place at `/editor`'s own address. That is
        // the same page "View Submission" opens later, so there is exactly
        ...
        // tears down the editor and the exam store cleanly rather than
