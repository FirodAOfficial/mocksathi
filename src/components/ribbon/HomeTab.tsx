...
export function HomeTab({ editor, format, clipboard, onFind, onReplace, onOpenFontDialog }: HomeTabProps) {
  ...
  return (
    <>
      ...
      <RibbonGroup label="Font" onLaunch={onOpenFontDialog} launchLabel="Font dialog">
        <RibbonColumn>
          <RibbonRow>
            <SelectMenu
              label="Font"
            ...
            <Popover
              ...
              trigger={({ open, toggle, id, controls }) => (
                <button
                  ...
                  onClick={toggle}
                >
                  <span className={styles.caseGlyph}>Aa</span>
                ...
                <div className={styles.menu}>
                  {LETTER_CASES.map((option) => (
                    <button
                      ...
                      onMouseDown={(event) => event.preventDefault()}
                      onClick={() => {
                        changeCase(editor, option.value);
                        close();
                      }}
                    >
                      {option.label}
