...
export function Ribbon({ editor, format, clipboard, onFind, onReplace, onWordCount }: RibbonProps) {
  ...
  return (
    <div className={styles.ribbon}>
      ...
      >
        {activeTab === 'home' ? (
          <HomeTab editor={editor} format={format} clipboard={clipboard} onFind={onFind} onReplace={onReplace} />
        ) : null}
